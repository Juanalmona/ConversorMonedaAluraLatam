    ...
    public double buscaMonedas(String tipoMonedaOrigen, String tipoMonedaDestino){
        ...
        try (HttpClient client = HttpClient.newHttpClient()) {
            ...
            try {
                ...
                JsonObject conversionRates = jsonObject.getAsJsonObject("conversion_rates");
                // Convierte la respuesta JSON a un objeto Moneda utilizando Gson
                double valorAConvertir = conversionRates.get(tipoMonedaOrigen).getAsFloat() * conversionRates.get(tipoMonedaDestino).getAsFloat();
                return valorAConvertir;
            } catch (Exception e) {
                //Lanza una RuntimeException con mensaje de error
